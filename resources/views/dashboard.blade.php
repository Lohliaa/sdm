                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><a
                                    href="{{ url('transaksi-pembelian') }}" class="stretched-link">TRANSAKSI PEMBELIAN</a>
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><a
                                    href="{{ url('transaksi-pembelian-barang') }}" class="stretched-link">TRANSAKSI PEMBELIAN BARANG</a>
                            </div>
