...
<body>
    <div class="card shadow mb-4">
        <div class="card-header py-3 text-center">
            <h4 class="font-weight-bold text-primary mb-0">TAMBAH DATA SK GURU PEGAWAI SIT PERMATA</h4>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            <form action="{{ route('sk.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        <label>NIPY</label>
                        <input type="text" name="nipy" class="form-control" value="{{ old('nipy') }}">
                    </div>

                    <div class="col-md-6 mt-3">
                        <label>Gol Ruang</label>
                        <input type="text" name="gol_ruang" class="form-control" value="{{ old('gol_ruang') }}">
                    </div>
                    <div class="col-md-6 mt-3">
                        <label>Status Kepegawaian</label>
                        <input type="text" name="status_kepegawaian" class="form-control" value="{{ old('status_kepegawaian') }}">
